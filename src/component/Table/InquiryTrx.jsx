  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setData(response.InquiryTransactionList);
        ...
        <table className="min-w-full bg-white border rounded-lg shadow-lg text-xs text-left">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="text-left p-4 whitespace-nowrap">Date Inquiry</th>
              <th className="text-left p-4 whitespace-nowrap">Company Name</th>
              ...
              <th className="text-left p-4 whitespace-nowrap">Tariff</th>
              <th className="text-left p-4 whitespace-nowrap">
                Status Merchant
              </th>
                  ...
                  >
                    ...
                    <td className="p-4 whitespace-nowrap">
                      <div className="flex flex-col justify-start items-start">
                        <p>Location : {dataParsingDataDetail?.location}</p>
                        <p>In Time : {dataParsingDataDetail?.inTime}</p>
                      </div>
                    </td>
                    <td className="p-4 whitespace-nowrap">
              ...
              <div className="flex flex-col">
                ...
                <table className="min-w-full bg-white border rounded-lg shadow-lg text-base text-left mb-5">
                  ...
                  <tbody>
                    <tr>
                      <td className="p-4">
                        {selectedDetail.dataPOST.POSTDataResponse.data.location}
                      </td>
                      <td className="p-4">
                        {
                      ...
                      <td className="p-4">
                        {selectedDetail.dataPOST.POSTDataResponse.data.inTime}
                      </td>
                      <td className="p-4">
                        {selectedDetail.dataPOST.POSTDataResponse.data.outTime}
                      </td>
                    </tr>
                  </tbody>
                </table>
